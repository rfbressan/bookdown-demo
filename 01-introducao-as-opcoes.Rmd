...
kable(tbl,
      ...
      caption = "Exemplo: Comprando call de X com o preço de exercício (strike) de 10.000",
      booktabs = TRUE)
```
...
```{r call, fig.cap = "Perfil de lucro típico de uma compra de call."}
