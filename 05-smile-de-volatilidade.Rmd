...
```{r smile-cambial, fig.cap = "Smile típico de um mercado cambial.", echo=FALSE}
knitr::include_graphics("./images/smile_cambial.png")
```
...
```{r smile-equities, fig.cap = "Smile típico de uma ação ou índice de ações.", echo=FALSE}
knitr::include_graphics("./images/smile_equities.png")
```
...
```{r superficie, fig.cap = "Superfície de volatilidade implícita.", echo=FALSE}
knitr::include_graphics("./images/spx_vol_surface.png")
```
...
```{r trava-alta, fig.cap="Perfil de lucro de uma trava de alta.", echo=FALSE}
knitr::include_graphics("./images/trava_alta.png")
```
...
```{r borboleta, fig.cap="Borboleta realizada com calls.", echo=FALSE}
knitr::include_graphics("./images/borboleta.png")
```
